...
- Главы хранятся в БД (`chapters`/`chapter_revisions`), slug уникален в пределах блога
- Публичные страницы: лента, каталог блогов, ридер главы, публичный профиль, доска «Ищем ревьюеров»
...
4. **sitemap.ts**: существует ли `app/sitemap.ts`? Включает ли все опубликованные главы/блоги?
