...
| **`flows/featured.spec.ts`** | **Ф15:** FEATURED-01…07 — витрина, порог, «Выбор редакции», SEO; + фильтр «Проверенные» и чип-ряд «Фильтр ленты» (ui-feedback-7/8, внутри FEATURED-03) |
