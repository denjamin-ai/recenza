...
| **`flows/featured.spec.ts`** | **Ф15:** FEATURED-01…07 — витринный отбор, порог, закрепления редакции, SEO; + фильтр «Проверенные» и чип-ряд «Фильтр ленты» (uif-7/8; uif-10: h1 всегда «Лента», подборка гостя одним списком) |
