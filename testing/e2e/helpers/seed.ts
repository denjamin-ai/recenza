 ...
 * uif-10: режимных заголовков на главной больше нет (h1 всегда «Лента», подборка одним
 * списком), но ПРАВИЛА отбора живы: скрыв один проверенный админом, тесты опускают счётчик
 * ниже порога (режим редакции внутри `getShowcase`).
 */
