...
export class ReaderPage {
  ...
  /**
   * ui-feedback-9/10: h1 главной ЕДИНЫЙ — «Лента» на подписках, в каталоге И у гостя;
   * состояние различают чипы «Фильтра ленты» (`aria-current`) и URL, не заголовок.
   * ⚠️ Ф15 (содержимое, не заголовок): гостю `/` отдаёт витринную подборку одним списком
   * (закреплённые редакцией + независимо проверенные), режимных h1 больше нет.
   */
  homeHeading(name: "Лента"): Locator {
