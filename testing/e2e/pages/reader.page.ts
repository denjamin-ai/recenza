...
export class ReaderPage {
  ...
  /**
   * Главная без табов (ui-feedback-4 П2). Ф13: любой вошедший → «Ваша лента».
   * ⚠️ Ф15: гостю главная отдаёт ВИТРИНУ, а не каталог: «Проверенные блоги» либо «Выбор редакции»
   * (когда проверенных меньше порога). Каталог «Все блоги» живёт на `?view=all`.
   */
  homeHeading(name: "Все блоги" | "Ваша лента" | "Проверенные блоги" | "Выбор редакции"): Locator {
