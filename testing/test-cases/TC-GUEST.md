...
### Objective
Гость без сессии видит главную — ⚠️ **Ф15: это ВИТРИНА проверенных блогов, а не каталог**
(каталог «Все блоги» переехал на `/?view=all`). Карточки БЛОГОВ (ui-feedback-4 П2: табы
«Лента/Каталог/Подписки» и поиск удалены), карусель промо-баннеров (в т.ч. слайд «Ищем ревьюеров»
с CTA «Стать ревьюером») и служебный подвал (Ф15, З-28).
...
1. Открыть `http://localhost:3001/`.
   **Expected:** Страница отдаётся без редиректа; в шапке — ссылка «Войти» (меню пользователя отсутствует, «Лента» — в правом кластере шапки); h1 **«Проверенные блоги»** (либо «Выбор редакции», если проверенных меньше трёх); сетка карточек БЛОГОВ — видна карточка «Глубоко в асинхронность JavaScript» (обложка, eyebrow «N глав», автор, теги, чип «Проверено на Recenza»). Блог с бейджем «приглашённым экспертом» на витрине ОТСУТСТВУЕТ. Табов и строки поиска НЕТ. В подвале — «О платформе», «Как стать ревьюером», RSS.
