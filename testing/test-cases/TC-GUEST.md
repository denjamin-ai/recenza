...
## TC-GUEST-01: Главная-витрина доступна гостю, карусель промо-баннеров видна

**Priority:** P1
**Type:** Functional / UI

### Objective
Гость без сессии видит главную — ⚠️ **Ф15 (содержимое): это ВИТРИННАЯ подборка проверенных
блогов, а не каталог** (каталог на `/?view=all`); **uif-10 (рамка): h1 всегда «Лента»**, чипы
«Все/Проверенные» без активного, подборка одним списком без заголовков секций. Карточки БЛОГОВ
(ui-feedback-4 П2: табы «Лента/Каталог/Подписки» и поиск удалены), карусель промо-баннеров
(в т.ч. слайд «Ищем ревьюеров» с CTA «Стать ревьюером») и служебный подвал (Ф15, З-28).
...
1. Открыть `http://localhost:3001/`.
   **Expected:** Страница отдаётся без редиректа; в шапке — ссылка «Войти» (меню пользователя отсутствует, «Лента» — в правом кластере шапки); h1 **«Лента»** (uif-10: режимных заголовков «Проверенные блоги»/«Выбор редакции» больше нет), чип-ряд «Все / Проверенные» без активного и без «Подписок»; один список карточек БЛОГОВ — видна карточка «Глубоко в асинхронность JavaScript» (обложка, eyebrow «N глав», автор, теги, чип «Проверено на Recenza»). Блог с бейджем «приглашённым экспертом» в подборке ОТСУТСТВУЕТ. Табов и строки поиска НЕТ. В подвале — «О платформе», «Как стать ревьюером», RSS.
...
7. Открыть `/` (главная читателя — h1 «Лента», чип «Подписки» активен; uif-9).
...
## TC-GUEST-11: Скрытый блог: нет на витрине и в каталоге, прямой URL → 404 (негатив)
...
### Test Steps
1. Открыть `/` (главная гостя — витрина проверенных, Ф15; чип-ряд «Все / Проверенные» без активного).
