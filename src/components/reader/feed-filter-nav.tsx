...
export function FeedFilterNav({
  ...
  /**
   * ui-feedback-9: опционален — на ВИТРИНЕ гостя чипы рендерятся без активного:
   * витрина — не состояние каталога (featured без бейджа есть, invited нет), врать
   * `aria-current` нельзя; чипы там — входы в ленту.
   */
  active?: FeedFilter;
