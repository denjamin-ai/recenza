      ...
      <div>
        ...
        <p className="mt-1 text-[0.7rem] text-[var(--muted-foreground)]">
          ...
          <strong className="font-medium text-[var(--warning)]">
            Снятие «вести блоги» скрывает все блоги автора и раздел «Об авторе» — из ленты,
            каталога, поиска и по прямой ссылке
          </strong>{" "}
          — вернёте возможность, вернётся и контент. Кредит ревью не затрагивается.
        </p>
      </div>
