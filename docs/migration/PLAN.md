...
| 14 | Ревью 2.0: заявки, каналы, бейджи | Продукт | `in progress` |
...
**Статус:** `in progress` (открыта 2026-07-25, ветка `phase-14-review-queue`, один PR)
...
**Журнал фазы.** (заполняется по ходу и при закрытии)
- Статус-история: `todo` → `in progress` (2026-07-25, ветка `phase-14-review-queue`)
