...
| 15 | UX читателя/автора и кабинет администратора | Продукт | `in progress` |
...
**Статус:** `in progress` (2026-07-25, ветка `phase-15-ux-and-admin`, один PR)
...
**Журнал фазы.** (заполняется по ходу и при закрытии)
- Статус-история: `todo` → `in progress` (2026-07-25) → …
